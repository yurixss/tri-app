...
export default function SwimScreen() {
  ...
  const swimmingCitations = [{ category: 'Training Zones', ...TRAINING_ZONES_CITATIONS.swimming }];
          ...
          {hasCalculated && zones.length > 0 && (
            ...
            >
              ...
              >
                ...
                >
                  <ThemedText style={[styles.sourcesButtonText, { color: Colors.shared.swim }]}>
                    ℹ️ Fontes
                  </ThemedText>
                </TouchableOpacity>
              </View>
